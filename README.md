...
[![version](https://img.shields.io/badge/Version-0.13.2-brightgreen)](https://github.com/horrible-dong/QTClassification)
...
|          `--comp_dirs`          |                                                                                  List of log/output dir paths to compare. The compared logs will be plotted together with the current log in the same figure.                                                                                   |       `[]`       |
|    `--batch_size`<br />`-b`     |                                                                                                                                                /                                                                                                                                                |      `256`       |
|           `--epochs`            |                                                                                                                                                /                                                                                                                                                |      `300`       |
